/**
 * Pitstop MCP tool catalogue — schemas + descriptions + cross-tool prose.
 *
 * Lives separately from `index.ts` so the server-wiring file stays thin (~30
 * lines) and tool authoring/copy-editing is a single landing pad. When you add
 * a tool, edit a description, or tune a schema field — this is the one file.
 */
